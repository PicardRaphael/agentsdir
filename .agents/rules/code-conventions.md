...
- **Dépendances d'exécution limitées** à `citty`, `@clack/prompts`, `smol-toml`. Toute addition exige une justification écrite dans `docs/architecture.md`, dans le même commit.
