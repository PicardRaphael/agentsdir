...
| 6 | Les messages de la CLI suffisent | coller les sorties conservées à une session sans dépôt ni documentation (`--tools ""`) et lui demander, pour chaque commande, si elle sait quoi faire ensuite et ce qui lui manque | une étape suivante identifiable après chaque commande |
