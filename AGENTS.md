...
- `.agents/tasks/` — backlog : 17 à 23 (dette technique issue du premier audit), 24 à 30 (produit), 31, 32, 35 et 36 (issues de l'audit du 30 août 2026 : promesses non tenues, contrat de la CLI, gardes non testées). L'ordre de prise est celui de `docs/positionnement.md`, pas l'ordre des numéros.
